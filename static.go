...
func (app *App) ServeFile(w http.ResponseWriter, r *http.Request, name string) int {
	...
	return app.serveFile(w, r, http.Dir(dir), file, false)
}
...
func (app *App) serveFile(w http.ResponseWriter, r *http.Request, fs http.FileSystem, name string, redirect bool) int {
	...
	if err != nil {
		...
		app.Logger.Println("f.Stat error", name, err.Error())
		http.Error(w, msg, code)
		return code
	}
...
func dirList(w http.ResponseWriter, f http.File) int {
